...
import com.bj58.spat.hades.multipart.MediaType;
...
import com.bj58.spat.hades.utils.WebUtils;
...
public class CommonsMultipartResolver {
	...
	public CommonsMultipartHttpServletRequest resolveMultipart(final HttpServletRequest request) throws Exception {
		...
		if (this.resolveLazily) {
			...
			return new CommonsMultipartHttpServletRequest(
	...
	private String determineEncoding(String contentTypeHeader, String defaultEncoding) {
		if (!StringUtil.hasText(contentTypeHeader)) {
